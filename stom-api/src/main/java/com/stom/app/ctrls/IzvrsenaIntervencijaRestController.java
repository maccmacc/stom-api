...
public class IzvrsenaIntervencijaRestController {
	...
	@CrossOrigin
	@GetMapping(value = "izvrsenaIntervencija", params = { "page", "size" })
	public Page<IzvrsenaIntervencija> getPacijent(@RequestParam("page") int page, @RequestParam("size") int size) {		
		return izvrsenaIntervencijaRepository.findAll(PageRequest.of(page, size));
	}
